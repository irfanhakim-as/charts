...
*/}}
{{- define "rizz.labels" -}}
helm.sh/chart: {{ include "rizz.chart" . }}
{{ include "rizz.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "rizz.selectorLabels" -}}
app.kubernetes.io/name: {{ include "rizz.name" . }}
...
*/}}
{{- define "rizz.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "rizz.fullname" .) .Values.serviceAccount.name }}
{{- else }}
