...
```sh
cp moekai/yuzu-multiplayer/values.yaml .
```
...
```sh
helm install $release_name moekai/yuzu-multiplayer --namespace $namespace --create-namespace --values values.yaml --wait
```
...
```sh
helm upgrade $release_name moekai/yuzu-multiplayer --namespace $namespace --values values.yaml --wait
```
