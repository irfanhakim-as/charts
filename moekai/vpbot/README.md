...
```sh
helm install $release_name moekai/vpbot --namespace $namespace --create-namespace --values values.yaml --wait
```
...
```sh
helm upgrade --install $release_name moekai/vpbot \
--namespace $namespace \
--values values.yaml \
